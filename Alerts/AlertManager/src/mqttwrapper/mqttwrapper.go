...
var password = globalconstants.MqttPassword
var user = globalconstants.MqttUsername
var id = "AlertManager"
//var id := flag.String("id", "testgoid", "The ClientID (optional)")
var cleansess = globalconstants.MqttCleanSession
var num = globalconstants.MqttNoOfMessages
...
func MqttClient(broker string, logger *log.Entry) MQTT.Client{
