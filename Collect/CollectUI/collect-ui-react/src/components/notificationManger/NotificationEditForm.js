...
class NotificationEditForm extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            emailAddress: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].email.to : '',
            notificationName: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].name : '',
            notificationPreviousName: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].name : '',
            emailSubject: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].email.subject : EmailDefaultSubject,
            emailMessage: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].email.message : EmailDefaultMessage,
            phoneNumber: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].sms.to : '',
            smsMessage: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].sms.message : SMSDefaultMessage,
            editVal: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].id : '',
            recoveryAlert: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].recoveryalert : false,
            enabled: this.props.SingleNotificationBucket.length > 0 ? this.props.SingleNotificationBucket[0].enabled : true,
            fields: {},
            errors: {},
            isError:false,
            errorMessage:'',
    ...
    handleInputValueChange = (e) => {
        ...
        if (e.target.id === "notificationname") {
            ...
            if(this.state.notificationPreviousName !== value){
